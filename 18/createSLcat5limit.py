...
def run_combine_card():
    ...
    command = "combineCards.py" + "FHSL_1jets_M3000_cat0=Datacard_M3000_1jets_cat0_FHSL.txt FHSL_1jets_M3000_cat5=Datacard_M3000_1jets_cat5_FHSL.txt FHSL_1jets_M3000_cat2=Datacard_M3000_1jets_cat2_FHSL.txt FHSL_1jets_M3000_cat5=Datacard_M3000_1jets_cat5_FHSL.txt   > Datacard_combined_FHSL_1jets_M3000.txt"
...
mass_list=["M250_SL","M260_SL","M270_SL","M280_SL","M300_SL","M320_SL","M350_SL","M400_SL","M450_SL","M500_SL","M550_SL","M600_SL","M650_SL","M700_SL","M750_SL","M800_SL","M850_SL"]
# mass_list=["M1000_SL"]#,"M900_SL","M1100_SL","M1200_SL","M1300_SL","M1400_SL","M1500_SL","M1600_SL","M1700_SL","M1800_SL","M1900_SL","M2000_SL","M2200_SL","M2400_SL","M2600_SL","M2800_SL","M3000_SL"]#

mass_list = ["M900_SL"]

final_state = "SL"
cat_list = ['combineFHSL_cat5highpt','combineFHSL_cat5lowpt']

for mass in mass_list:
    for cat in cat_list:
        # ------------------------------------- log path -------------------------------------
        log_path = "/eos/user/s/shsong/hhwwgg_workspace/Final_limit/cat5log/"
        # ------------------------------------- background fit -------------------------------------
        input_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat5/2018/flashgginput/" + mass + "/"
        # exist_background_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat5/2018/flashgginput/M1000_SL/"
        exist_background_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat5/2018/flashgginput/M1000_SL/"
