...
def run_ftest(ws_path, log_name, inputpath_name, process):
    ...
    # run ftest
    command = "python RunSignalScripts.py --inputConfig " +  "config_" +process+ ws_path + ".py"+ " --mode 'fTest' --doPlots" + " > " + log_name + " 2>&1"
...
def run_combine_card():
    ...
    command = "combineCards.py" + "FHSL_1jets_M3000_cat0=Datacard_M3000_1jets_cat0_FHSL.txt FHSL_1jets_M3000_cat1=Datacard_M3000_1jets_cat1_FHSL.txt FHSL_1jets_M3000_cat2=Datacard_M3000_1jets_cat2_FHSL.txt FHSL_1jets_M3000_cat8=Datacard_M3000_1jets_cat8_FHSL.txt   > Datacard_combined_FHSL_1jets_M3000.txt"
...
# mass_list = ["M250_FH","M260_FH","M270_FH","M280_FH","M300_FH","M320_FH","M350_FH","M400_FH","M450_FH","M500_FH","M550_FH","M600_FH","M650_FH","M700_FH","M750_FH","M800_FH","M850_FH","M900_FH","M1000_FH"]
mass_list = ["M700_FH","M750_FH","M800_FH","M850_FH","M900_FH","M1000_FH"]
final_state = "FH"
...
for mass in mass_list:
    for cat in cat_list:
        ...
        # ------------------------------------- background fit -------------------------------------
        input_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat8/2018/flashgginput/" + mass + "/"
        exist_background_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat8/2018/flashgginput/M1000_FH/"
