...
def run_combine_card():
    ...
    command = "combineCards.py" + "FHSL_1jets_M3000_cat0=Datacard_M3000_1jets_cat0_FHSL.txt FHSL_1jets_M3000_cat1=Datacard_M3000_1jets_cat1_FHSL.txt FHSL_1jets_M3000_cat2=Datacard_M3000_1jets_cat2_FHSL.txt FHSL_1jets_M3000_cat1=Datacard_M3000_1jets_cat1_FHSL.txt   > Datacard_combined_FHSL_1jets_M3000.txt"
...
# mass_list = ["M1000_SL"]"M1100_SL","M1200_SL","M1300_SL","M1400_SL","M1500_SL","M1600_SL","M1700_SL","M1800_SL","M1900_SL","M2000_SL","M2200_SL","M2400_SL","M2600_SL","M2800_SL",
...
for mass in mass_list:
    for cat in cat_list:
        ...
        # ------------------------------------- background fit -------------------------------------
        input_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat1/2018/flashgginput/" + mass + "/"
        # exist_background_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat1/2018/flashgginput/M1000_SL/"
        exist_background_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat1/2018/flashgginput/M1000_SL/"
