...
def run_Tree2WS_sig(inputpath_name, inputfile_name, log_file_name, ws_path, output_sig_root_name, process):
    ...
    command = " python trees2ws.py --inputConfig config_sys.py --inputTreeFile " + inputpath_name+inputfile_name + " --inputMass 125  --doSystematics --productionMode " + process_prefix + " --year 2018  > " + log_file_name+ " 2>&1"
...
def run_signal_plot(outputExt, cats, exts,log_packaged_name,ws_path,inputpath_name,log_plotter_name, cp_name, process):
    ...
    # run plotter
    command = "python RunPlotter.py --cats " + cats + " --procs all --years 2018 --ext " + outputExt + " > " + log_plotter_name + " 2>&1"
...
def run_combine_card():
    ...
    command = "combineCards.py" + "FHSL_1jets_M3000_cat0=Datacard_M3000_1jets_cat0_FHSL.txt FHSL_1jets_M3000_cat3=Datacard_M3000_1jets_cat3_FHSL.txt FHSL_1jets_M3000_cat2=Datacard_M3000_1jets_cat2_FHSL.txt FHSL_1jets_M3000_cat3=Datacard_M3000_1jets_cat3_FHSL.txt   > Datacard_combined_FHSL_1jets_M3000.txt"
...
# example
# mass_list=["M250_SL","M260_SL","M270_SL","M280_SL","M300_SL","M320_SL","M350_SL","M400_SL","M450_SL","M500_SL","M550_SL","M600_SL","M650_SL","M700_SL","M750_SL","M800_SL","M850_SL","M900_SL","M1100_SL","M1200_SL","M1300_SL","M1400_SL","M1500_SL","M1600_SL","M1700_SL","M1800_SL","M1900_SL","M2000_SL","M2200_SL","M2400_SL","M2600_SL","M2800_SL","M3000_SL"]#
# mass_list=["M800_SL","M850_SL","M900_SL","M1100_SL","M1200_SL","M1300_SL","M1400_SL","M1500_SL","M1600_SL","M1700_SL","M1800_SL","M1900_SL","M2000_SL","M2200_SL","M2400_SL","M2600_SL","M2800_SL","M3000_SL"]#
mass_list=["M800_SL"]#

# mass_list = []

final_state = "SL"
cat_list = ['combineFHSL_cat3highpt','combineFHSL_cat3lowpt',]
...
for mass in mass_list:
    for cat in cat_list:
        ...
        # ------------------------------------- background fit -------------------------------------
        input_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat3/2018/flashgginput/" + mass + "/"
        exist_background_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat3/2018/flashgginput/M1000_SL/"
        ...
        input_file_name_signal = "Signal_"+ mass +"_2018_"+cat+".root"
        log_file_name_signal = mass +"_hhwwgg_MC_2018_"+cat+".log"
        ...
        run_makeDatacard(ws_sig_path=ws_path_signal, log_name = log_path + mass + cat + "_makeDatacard.log" , output_card_name = "Datacard_" + mass +"_2018_" + cat, channel=mass,process='gghh'+ final_state) 
        # run_combine(output_file_name=mass +"_2018_" + cat, log_name = log_path + mass +"_2018_" + cat +"_combine_limit.log" , output_card_name = "Datacard_" + mass +"_2018_" + cat)
