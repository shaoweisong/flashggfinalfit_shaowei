...
def run_combine_card():
    ...
    command = "combineCards.py" + "FHSL_1jets_M3000_cat0=Datacard_M3000_1jets_cat0_FHSL.txt FHSL_1jets_M3000_cat2=Datacard_M3000_1jets_cat2_FHSL.txt FHSL_1jets_M3000_cat2=Datacard_M3000_1jets_cat2_FHSL.txt FHSL_1jets_M3000_cat2=Datacard_M3000_1jets_cat2_FHSL.txt   > Datacard_combined_FHSL_1jets_M3000.txt"
...
# mass_list = ["M500_SL","M600_SL","M700_SL","M800_SL","M900_SL","M2000_SL","M3000_SL"]#,"M1000_SL","M250_SL","M300_SL"noevent"M400_SL",
mass_list = ["M250_SL","M260_SL","M270_SL","M280_SL","M300_SL","M320_SL","M350_SL","M400_SL","M450_SL","M500_SL","M550_SL","M600_SL","M650_SL","M700_SL","M750_SL","M800_SL","M850_SL","M900_SL","M1000_SL"]
# mass_list = ["M270_SL","M850_SL","M800_SL"]
# mass_list = ["M1000_SL","M1900_SL",]
# mass_list = ["M2000_SL","M1000_SL"]
final_state = "SL"
# cat_list = ['combineFHSL_cat5lowpt','combineFHSL_cat5highpt']
# cat_list = ['combineFHSL_cat7lowpt','combineFHSL_cat7highpt']
cat_list = ['combineFHSL_cat2lowpt','combineFHSL_cat2highpt','combineFHSL_cat2lowpurity','combineFHSL_cat2mediumpurity','combineFHSL_cat2highpurity']
# cat_list = ['combineFHSL_cat2lowpt','combineFHSL_cat2highpt']
# cat_list = ['cat2']
# cat_list = ['cat2']
...
for mass in mass_list:
    for cat in cat_list:
        ...
        # ------------------------------------- background fit -------------------------------------
        input_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat2/2018/flashgginput/" + mass + "/"
        # exist_background_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat2/2018/flashgginput/M1000_SL/"
