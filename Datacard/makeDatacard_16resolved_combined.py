...
from systematics_16resolved_combined import theory_systematics, experimental_systematics, signal_shape_systematics
...
if opt.prune:
  ...
  if opt.doTrueYield:
    ...
    # data.loc[data['proc'].str.contains('VBF'), 'type'] = 'bkg'
