...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M250 -d Datacard_M250_2017allcat.root --run expected --freezeParameters allConstrainedNuisances --rMax 40000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M260 -d Datacard_M260_2017allcat.root --run expected --freezeParameters allConstrainedNuisances --rMax 20000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M270 -d Datacard_M270_2017allcat.root --run expected --freezeParameters allConstrainedNuisances --rMax 20000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M280 -d Datacard_M280_2017allcat.root --run expected --freezeParameters allConstrainedNuisances --rMax 20000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M300 -d Datacard_M300_2017allcat.root --run expected --freezeParameters allConstrainedNuisances --rMax 10000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M320 -d Datacard_M320_2017allcat.root --run expected --freezeParameters allConstrainedNuisances --rMax 10000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M350 -d Datacard_M350_2017allcat.root --run expected --freezeParameters allConstrainedNuisances --rMax 10000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M400 -d Datacard_M400_2017allcat.root --run expected --freezeParameters allConstrainedNuisances --rMax 10000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M450 -d Datacard_M450_2017allcat.root --run expected --freezeParameters allConstrainedNuisances --rMax 10000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M500 -d Datacard_M500_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M550 -d Datacard_M550_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M600 -d Datacard_M600_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
...
combine  -v 10 -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M650 -d Datacard_M650_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M700 -d Datacard_M700_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M750 -d Datacard_M750_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M800 -d Datacard_M800_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M850 -d Datacard_M850_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M900 -d Datacard_M900_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M1000 -d Datacard_M1000_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M1100 -d Datacard_M1100_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
 d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M1200
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M1200 -d Datacard_M1200_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
 d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M1300
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M1300 -d Datacard_M1300_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
 d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M1400
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M1400 -d Datacard_M1400_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
 d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M1500
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M1500 -d Datacard_M1500_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
 d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M1600
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M1600 -d Datacard_M1600_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
 d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M1700
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M1700 -d Datacard_M1700_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
 d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M1800
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M1800 -d Datacard_M1800_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
 d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M1900
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M1900 -d Datacard_M1900_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
 d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M2000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M2000 -d Datacard_M2000_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
 d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M2200
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M2200 -d Datacard_M2200_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
 d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M2400
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M2400 -d Datacard_M2400_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
 d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M2600
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M2600 -d Datacard_M2600_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
 d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M2800
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M2800 -d Datacard_M2800_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
 d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M3000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_2017allcat_M3000 -d Datacard_M3000_2017allcat.root --run expected --freezeParameters allConstrainedNuisances 
