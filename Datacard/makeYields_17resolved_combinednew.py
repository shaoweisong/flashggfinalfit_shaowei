...
from systematics_17resolved_combined import theory_systematics, experimental_systematics, signal_shape_systematics
...
def get_options():
  parser = OptionParser()
  parser.add_option('--inputWSDirMap', dest='inputWSDirMap', default='207:/vols/cms/jl2117/hgg/ws/UL/Sept20/MC_final/signal_207', help="Map. Format: year=inputWSDir (separate years by comma)")
