...
# combine -M AsymptoticLimits -m 125 -n combineFHSL_cat5_M280 -d Datacard_M280_cat5.root --run expected  --rMax 20000  
...
# cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016predatacard/datacard_M320/Datacard_M320_cat5lowpt.txt Datacard_M320_cat5.txt
...
# cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016predatacard/datacard_M350/Datacard_M350_cat5lowpt.txt Datacard_M350_cat5.txt
...
# cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016predatacard/datacard_M400/Datacard_M400_cat5lowpt.txt Datacard_M400_cat5.txt
...
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016predatacard/datacard_M3000/Datacard_M3000_cat5highpt.txt Datacard_M3000_cat5.txt
