...
from tools.submissionTools_16resolved_combined import *
...
def get_options():
  ...
  parser.add_option('--inputWSDirMap', dest='inputWSDirMap', default='2016=/vols/cms/jl216/hgg/ws/UL/Sept20/MC_final/signal_2016', help="Map. Format: year=inputWSDir (separate years by comma)")
