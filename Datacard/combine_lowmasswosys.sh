...
combine -M AsymptoticLimits -m 125 -n combine_M250_wosys -d Datacard_M250_cat128.txt --run expected --freezeParameters allConstrainedNuisances --rMax 50000
...
combine -M AsymptoticLimits -m 125 -n combine_M300_wosys -d Datacard_M300_cat12378.txt --run expected --freezeParameters allConstrainedNuisances --rMax 50000
...
combine -M AsymptoticLimits -m 125 -n combine_M400_wosys -d Datacard_M400_cat12378.txt --run expected --freezeParameters allConstrainedNuisances --rMax 50000
...
combine -M AsymptoticLimits -m 125 -n combine_M500_wosys -d Datacard_M500_cat123578.txt --run expected --freezeParameters allConstrainedNuisances 
...
combine -M AsymptoticLimits -m 125 -n combine_M600_wosys -d Datacard_M600_cat123578.txt --run expected --freezeParameters allConstrainedNuisances  
...
combine -M AsymptoticLimits -m 125 -n combine_M700_wosys -d Datacard_M700_cat123578.txt --run expected --freezeParameters allConstrainedNuisances  
...
combine -M AsymptoticLimits -m 125 -n combine_M800_wosys -d Datacard_M800_cat123578.txt --run expected --freezeParameters allConstrainedNuisances  
...
combine -M AsymptoticLimits -m 125 -n combine_M900_wosys -d Datacard_M900_cat123578.txt --run expected --freezeParameters allConstrainedNuisances  
...
combine -M AsymptoticLimits -m 125 -n combine_M1000_wosys -d Datacard_M1000_cat123578.txt --run expected --freezeParameters allConstrainedNuisances  
