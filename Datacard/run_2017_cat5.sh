...
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M250/Datacard_M250_cat5lowpt.txt Datacard_M250_cat5.txt
text2workspace.py Datacard_M250_cat5.txt -m 125
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat5_M250 -d Datacard_M250_cat5.root --run expected   --rMax 100000 
cd /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M260
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M260/Datacard_M260_cat5lowpt.txt Datacard_M260_cat5.txt
text2workspace.py Datacard_M260_cat5.txt -m 125
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat5_M260 -d Datacard_M260_cat5.root --run expected   --rMax 100000 
cd /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M270
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M270/Datacard_M270_cat5lowpt.txt Datacard_M270_cat5.txt
...
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M280/Datacard_M280_cat5lowpt.txt Datacard_M280_cat5.txt
...
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M320/Datacard_M320_cat5lowpt.txt Datacard_M320_cat5.txt
...
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M350/Datacard_M350_cat5lowpt.txt Datacard_M350_cat5.txt
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat5_M400 -d Datacard_M400_cat5.root --run expected   --rMax 10000 
cd /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M450
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M450/Datacard_M450_cat5lowpt.txt Datacard_M450_cat5.txt
text2workspace.py Datacard_M450_cat5.txt -m 125
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat5_M450 -d Datacard_M450_cat5.root --run expected   --rMax 10000 
cd /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M500
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M500/Datacard_M500_cat5lowpt.txt Datacard_M500_cat5.txt
text2workspace.py Datacard_M500_cat5.txt -m 125
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat5_M500 -d Datacard_M500_cat5.root --run expected   --rMax 10000 
cd /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M550
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M550/Datacard_M550_cat5lowpt.txt Datacard_M550_cat5.txt
text2workspace.py Datacard_M550_cat5.txt -m 125
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat5_M550 -d Datacard_M550_cat5.root --run expected   --rMax 10000 
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat5_M600 -d Datacard_M600_cat5.root --run expected   --rMax 10000 
cd /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M650
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M650/Datacard_M650_cat5lowpt.txt Datacard_M650_cat5.txt
...
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/datacard_M750/Datacard_M750_cat5lowpt.txt Datacard_M750_cat5.txt
