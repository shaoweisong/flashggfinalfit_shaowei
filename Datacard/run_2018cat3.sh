...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M250 -d Datacard_M250_cat3.root --run expected    --rMax 50000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M260 -d Datacard_M260_cat3.root --run expected    --rMax 50000
cd /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2018datacard/datacard_M270
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2018datacard/datacard_M270/Datacard_M270_cat3lowpt.txt Datacard_M270_cat3.txt
text2workspace.py Datacard_M270_cat3.txt -m 125
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M270 -d Datacard_M270_cat3.root --run expected    --rMax 50000
cd /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2018datacard/datacard_M280
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2018datacard/datacard_M280/Datacard_M280_cat3lowpt.txt Datacard_M280_cat3.txt
text2workspace.py Datacard_M280_cat3.txt -m 125
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M280 -d Datacard_M280_cat3.root --run expected    --rMax 50000
cd /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2018datacard/datacard_M300
combineCards.py  cat3_M300=Datacard_M300_cat3highpt.txt Datacard_M300_cat3lowpt.txt > Datacard_M300_cat3.txt
text2workspace.py Datacard_M300_cat3.txt -m 125
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M300 -d Datacard_M300_cat3.root --run expected    --rMax 50000
cd /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2018datacard/datacard_M320
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2018datacard/datacard_M320/Datacard_M320_cat3lowpt.txt Datacard_M320_cat3.txt
text2workspace.py Datacard_M320_cat3.txt -m 125
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M320 -d Datacard_M320_cat3.root --run expected    --rMax 50000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M350 -d Datacard_M350_cat3.root --run expected    --rMax 50000
cd /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2018datacard/datacard_M400
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2018datacard/datacard_M400/Datacard_M400_cat3lowpt.txt Datacard_M400_cat3.txt
text2workspace.py Datacard_M400_cat3.txt -m 125
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M400 -d Datacard_M400_cat3.root --run expected    --rMax 50000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M450 -d Datacard_M450_cat3.root --run expected    --rMax 50000
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M500 -d Datacard_M500_cat3.root --run expected    
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M550 -d Datacard_M550_cat3.root --run expected    
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M600 -d Datacard_M600_cat3.root --run expected    
...
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2018datacard/datacard_M1900/Datacard_M1900_cat3highpt.txt Datacard_M1900_cat3.txt
...
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2018datacard/datacard_M2200/Datacard_M2200_cat3highpt.txt Datacard_M2200_cat3.txt
...
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2018datacard/datacard_M2800/Datacard_M2800_cat3highpt.txt Datacard_M2800_cat3.txt
