...
if [ $1 -eq 134 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2016pre_13TeV_exp5_f1 --algo impact --redefineSignalPOIs r -P env_pdf_0_2016pre_13TeV_exp5_f1 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX1000_MY800_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 135 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2016pre_13TeV_exp5_f2 --algo impact --redefineSignalPOIs r -P env_pdf_0_2016pre_13TeV_exp5_f2 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX1000_MY800_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 136 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2016pre_13TeV_exp5_p1 --algo impact --redefineSignalPOIs r -P env_pdf_0_2016pre_13TeV_exp5_p1 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX1000_MY800_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 137 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2016pre_13TeV_exp5_p2 --algo impact --redefineSignalPOIs r -P env_pdf_0_2016pre_13TeV_exp5_p2 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX1000_MY800_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 138 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2016pre_13TeV_exp5_p3 --algo impact --redefineSignalPOIs r -P env_pdf_0_2016pre_13TeV_exp5_p3 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX1000_MY800_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 139 ]; then
