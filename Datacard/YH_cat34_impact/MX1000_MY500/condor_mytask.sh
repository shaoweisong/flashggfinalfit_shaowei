...
if [ $1 -eq 157 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2017_13TeV_pow3_f1 --algo impact --redefineSignalPOIs r -P env_pdf_0_2017_13TeV_pow3_f1 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX1000_MY500_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 158 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2017_13TeV_pow3_p1 --algo impact --redefineSignalPOIs r -P env_pdf_0_2017_13TeV_pow3_p1 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX1000_MY500_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 159 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2017_13TeV_pow3_p2 --algo impact --redefineSignalPOIs r -P env_pdf_0_2017_13TeV_pow3_p2 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX1000_MY500_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 160 ]; then
