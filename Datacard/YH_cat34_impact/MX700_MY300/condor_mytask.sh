...
if [ $1 -eq 87 ]; then
  combine -M MultiDimFit -n _paramFit_Test_PNWvsQCD_mistaggingSF_2016pre --algo impact --redefineSignalPOIs r -P PNWvsQCD_mistaggingSF_2016pre --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX700_MY300_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 88 ]; then
...
if [ $1 -eq 213 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2018_13TeV_bern5_p0 --algo impact --redefineSignalPOIs r -P env_pdf_0_2018_13TeV_bern5_p0 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX700_MY300_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 214 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2018_13TeV_bern5_p1 --algo impact --redefineSignalPOIs r -P env_pdf_0_2018_13TeV_bern5_p1 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX700_MY300_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 215 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2018_13TeV_bern5_p2 --algo impact --redefineSignalPOIs r -P env_pdf_0_2018_13TeV_bern5_p2 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX700_MY300_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 216 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2018_13TeV_bern5_p3 --algo impact --redefineSignalPOIs r -P env_pdf_0_2018_13TeV_bern5_p3 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX700_MY300_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 217 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2018_13TeV_bern5_p4 --algo impact --redefineSignalPOIs r -P env_pdf_0_2018_13TeV_bern5_p4 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX700_MY300_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 218 ]; then
