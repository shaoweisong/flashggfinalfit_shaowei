...
if [ $1 -eq 144 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2016pre_13TeV_bern7_p0 --algo impact --redefineSignalPOIs r -P env_pdf_0_2016pre_13TeV_bern7_p0 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX900_MY500_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 145 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2016pre_13TeV_bern7_p1 --algo impact --redefineSignalPOIs r -P env_pdf_0_2016pre_13TeV_bern7_p1 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX900_MY500_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 146 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2016pre_13TeV_bern7_p2 --algo impact --redefineSignalPOIs r -P env_pdf_0_2016pre_13TeV_bern7_p2 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX900_MY500_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 147 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2016pre_13TeV_bern7_p3 --algo impact --redefineSignalPOIs r -P env_pdf_0_2016pre_13TeV_bern7_p3 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX900_MY500_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 148 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2016pre_13TeV_bern7_p4 --algo impact --redefineSignalPOIs r -P env_pdf_0_2016pre_13TeV_bern7_p4 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX900_MY500_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 149 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2016pre_13TeV_bern7_p5 --algo impact --redefineSignalPOIs r -P env_pdf_0_2016pre_13TeV_bern7_p5 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX900_MY500_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 150 ]; then
  combine -M MultiDimFit -n _paramFit_Test_env_pdf_0_2016pre_13TeV_bern7_p6 --algo impact --redefineSignalPOIs r -P env_pdf_0_2016pre_13TeV_bern7_p6 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit 1 --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --freezeParameters MH --rMin -5 --rMax 5 -t -1 --expectSignal 1 -m 125 -d MX900_MY500_run2_cat34.root --setParameters MH=125.38
fi
if [ $1 -eq 151 ]; then
