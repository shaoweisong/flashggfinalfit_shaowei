...
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016postdatacard/datacard_M270/Datacard_M270_cat3lowpt.txt Datacard_M270_cat3.txt
text2workspace.py Datacard_M270_cat3.txt -m 125
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M270 -d Datacard_M270_cat3.root --run expected --rMax 20000   
cd /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016postdatacard/datacard_M280
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016postdatacard/datacard_M280/Datacard_M280_cat3lowpt.txt Datacard_M280_cat3.txt
text2workspace.py Datacard_M280_cat3.txt -m 125
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M280 -d Datacard_M280_cat3.root --run expected --rMax 20000   
cd /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016postdatacard/datacard_M300
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016postdatacard/datacard_M300/Datacard_M300_cat3lowpt.txt Datacard_M300_cat3.txt
text2workspace.py Datacard_M300_cat3.txt -m 125
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M300 -d Datacard_M300_cat3.root --run expected --rMax 20000   
cd /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016postdatacard/datacard_M320
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016postdatacard/datacard_M320/Datacard_M320_cat3lowpt.txt Datacard_M320_cat3.txt
text2workspace.py Datacard_M320_cat3.txt -m 125
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M320 -d Datacard_M320_cat3.root --run expected --rMax 20000   
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M350 -d Datacard_M350_cat3.root --run expected --rMax 20000   
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M400 -d Datacard_M400_cat3.root --run expected --rMax 20000   
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M450 -d Datacard_M450_cat3.root --run expected --rMax 20000   
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M500 -d Datacard_M500_cat3.root --run expected --rMax 20000   
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M550 -d Datacard_M550_cat3.root --run expected --rMax 20000   
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M600 -d Datacard_M600_cat3.root --run expected --rMax 20000   
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M650 -d Datacard_M650_cat3.root --run expected --rMax 20000   
...
combine -M AsymptoticLimits -m 125 -n combineFHSL_cat3_M700 -d Datacard_M700_cat3.root --run expected --rMax 20000   
...
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016postdatacard/datacard_M2400/Datacard_M2400_cat3highpt.txt Datacard_M2400_cat3.txt
...
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016postdatacard/datacard_M2600/Datacard_M2600_cat3highpt.txt Datacard_M2600_cat3.txt
...
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016postdatacard/datacard_M2800/Datacard_M2800_cat3highpt.txt Datacard_M2800_cat3.txt
...
cp /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/2016postdatacard/datacard_M3000/Datacard_M3000_cat3highpt.txt Datacard_M3000_cat3.txt
