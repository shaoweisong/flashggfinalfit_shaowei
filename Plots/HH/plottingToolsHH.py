...
def makeSplusBPlot(workspace,hD,hSB,hB,hS,hDr,hBr,hSr,cat,options,dB=None,reduceRange=None,limit=None,hC=None):
  ...
  else: leg = ROOT.TLegend(0.58,0.55,0.86,0.76)
  leg.SetFillStyle(0)
  leg.SetLineColor(0)
  ...
  if options.unblind:
    ...
    hS['pdfNBins'].SetFillColorAlpha(38,0.5)
  ...
  h_axes_ratio.Reset()
  h_axes_ratio.SetMaximum(max((hDr.GetMaximum()+hDr.GetBinError(hDr.GetMaximumBin()))*1.5,hSr.GetMaximum()*1))
