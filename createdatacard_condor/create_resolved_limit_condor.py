...
final_state = ""
cat_list = ['combineFHSL_cat34FHhighpurity','combineFHSL_cat34SLhighpurity','combineFHSL_cat34FHlowpurity','combineFHSL_cat34SLlowpurity','bbgg_cat34FHhighpurity','bbgg_cat34SLhighpurity','bbgg_cat34FHlowpurity','bbgg_cat34SLlowpurity''zzgg_cat34FHhighpurity','zzgg_cat34SLhighpurity','zzgg_cat34FHlowpurity','zzgg_cat34SLlowpurity']
for cat in cat_list:
    # ------------------------------------- background fit -------------------------------------
