...
def run_Tree2WS_sig(inputpath_name, inputfile_name, log_file_name, ws_path, output_sig_root_name, process):
    ...
    print("process_prefix: ", process_prefix).pdf
    ...
    command = " python trees2ws.py --inputConfig config_simple.py --inputTreeFile " + inputpath_name+inputfile_name + " --inputMass 125  --productionMode " + process_prefix + " --year 2018  > " + log_file_name+ " 2>&1"
...
def run_ftest(ws_path, log_name, inputpath_name, process):
    ...
    rm_p = subprocess.call(command, shell=True, stdout=subprocess.PIPE)
    #copy config_nosys.py
    command = "cp config_nosys.py " + "config_" +process+ ws_path + ".py"
    run_p = subprocess.call(command, shell=True, stdout=subprocess.PIPE)
    logging.info("copy config_nosys.py \n command :{0}".format(command))
    time.sleep(2)
    # sed config_*.py
...
def run_yields(ws_sig_path,ws_bkg_path, inputpath_name,log_name, process):
    ...
    # run Runyields
    command = "python RunYields.py --inputWSDirMap 2018=" +inputpath_name+ process + "_" + ws_sig_path+" --sigModelWSDir " + inputpath_name+ process + "_" + ws_sig_path+" --bkgModelWSDir " + inputpath_name+  ws_bkg_path + " --cats auto --procs auto --batch local --ext "+ ws_sig_path+ ">" + log_name+ " 2>&1"
...
def run_makeDatacard(ws_sig_path,output_card_name,log_name,channel,process):
    ...
    command = "python makeDatacard.py --years 2018 --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
    ...
    logging.info("end: {}".format(time.time()))
# mass_list=['MX500_MH125','MX550_MH125','MX600_MH125','MX650_MH125','MX700_MH125','MX750_MH125','MX800_MH125','MX850_MH125','MX1000_MH125', 'MX1100_MH125', 'MX1200_MH125', 'MX1300_MH125', 'MX1400_MH125', 'MX1500_MH125', 'MX1600_MH125', 'MX1700_MH125', 'MX1800_MH125','MX1900_MH125', 'MX2000_MH125', 'MX2200_MH125', 'MX2600_MH125', 'MX2800_MH125','MX2400_MH125','MX3000_MH125']

mass_list=['MX850_MH125','MX1100_MH125','MX3000_MH125','MX500_MH125','MX550_MH125','MX600_MH125','MX650_MH125','MX700_MH125','MX750_MH125','MX800_MH125','MX1200_MH125','MX1300_MH125','MX1400_MH125','MX1500_MH125','MX1600_MH125','MX1700_MH125','MX1800_MH125','MX1900_MH125','MX2000_MH125','MX2200_MH125','MX2600_MH125','MX2800_MH125','MX2400_MH125']
final_state = ""
...
for mass in mass_list:
    for cat in cat_list:
        ...
        # ------------------------------------- background fit -------------------------------------
        input_path_name = "/eos/cms/store/group/phys_b2g/shsong/flashggws/cat12/2018_05/" + mass + "/"
        ...
        input_file_name_signal = "CombineFHSL_"+ mass +"_2018_"+cat+".root"
