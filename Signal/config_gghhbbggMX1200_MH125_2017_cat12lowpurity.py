...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/eos/cms/store/group/phys_b2g/shsong/flashggws/cat12/2017_singleH/MX1200_MH125/ws_gghhbbgg_MX1200_MH125_2017_cat12lowpurity',
  'procs':'auto', # if auto: inferred automatically from filenames
  'cats':'auto', # if auto: inferred automatically from (0) workspace
  'ext':'dcb_%s_MX1200_MH125_2017_cat12lowpurity'%_year,
