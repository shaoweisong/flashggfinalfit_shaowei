...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/eos/cms/store/group/phys_b2g/shsong/flashggws/cat12/2016post/MX550_MH125/ws_gghhzzgg_MX550_MH125_2016post_cat12highpurity',
  'procs':'auto', # if auto: inferred automatically from filenames
  'cats':'auto', # if auto: inferred automatically from (0) workspace
  'ext':'dcb_%s_MX550_MH125_2016post_cat12highpurity'%_year,
