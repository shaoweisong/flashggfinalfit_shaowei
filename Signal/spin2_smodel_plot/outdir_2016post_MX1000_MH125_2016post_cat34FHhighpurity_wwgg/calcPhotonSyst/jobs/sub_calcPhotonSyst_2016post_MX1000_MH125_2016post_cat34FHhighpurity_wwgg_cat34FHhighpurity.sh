...
python /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Signal/scripts/calcPhotonSyst.py --cat cat34FHhighpurity --procs gghhwwgg --ext 2016post_MX1000_MH125_2016post_cat34FHhighpurity_wwgg --inputWSDir /eos/cms/store/group/phys_b2g/shsong/flashggws/cat34_graviton/2016post/MX1000_MH125/ws_gghhwwgg_MX1000_MH125_2016post_cat34FHhighpurity_wwgg --scales 'scale' --scalesCorr 'material,fnuf' --scalesGlobal '' --smears 'smear' 
