...
python /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Signal/scripts/fTest.py --cat cat34FHlowpurity --procs gghhwwgg --ext 2016pre_MX1000_MH125_2016pre_cat34FHlowpurity_wwgg --inputWSDir /eos/cms/store/group/phys_b2g/shsong/flashggws/cat34_graviton/2016pre/MX1000_MH125/ws_gghhwwgg_MX1000_MH125_2016pre_cat34FHlowpurity_wwgg --doPlots
