...
python /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Signal/scripts/signalFit.py --inputWSDir /eos/cms/store/group/phys_b2g/shsong/flashggws/cat34_graviton/2016post/MX1000_MH125/ws_gghhwwgg_MX1000_MH125_2016post_cat34SLhighpurity_wwgg --ext 2016post_MX1000_MH125_2016post_cat34SLhighpurity_wwgg --proc gghhwwgg --cat cat34SLhighpurity --year 2016post --analysis STXS --massPoints 125 --scales 'scale' --scalesCorr 'material,fnuf' --scalesGlobal '' --smears 'smear' 
