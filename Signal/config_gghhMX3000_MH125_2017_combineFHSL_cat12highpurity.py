...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/eos/user/s/shsong/MX3000_MH125/ws_gghh_MX3000_MH125_2017_combineFHSL_cat12highpurity',
  'procs':'auto', # if auto: inferred automatically from filenames
  'cats':'auto', # if auto: inferred automatically from (0) workspace
  'ext':'dcb_%s_MX3000_MH125_2017_combineFHSL_cat12highpurity'%_year,
