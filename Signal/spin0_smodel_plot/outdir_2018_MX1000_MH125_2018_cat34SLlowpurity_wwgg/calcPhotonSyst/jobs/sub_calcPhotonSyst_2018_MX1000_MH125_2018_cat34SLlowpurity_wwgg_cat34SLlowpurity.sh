...
python /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Signal/scripts/calcPhotonSyst.py --cat cat34SLlowpurity --procs gghhwwgg --ext 2018_MX1000_MH125_2018_cat34SLlowpurity_wwgg --inputWSDir /eos/cms/store/group/phys_b2g/shsong/flashggws/cat34/2018/MX1000_MH125/ws_gghhwwgg_MX1000_MH125_2018_cat34SLlowpurity_wwgg --scales '' --scalesCorr '' --scalesGlobal '' --smears '' 
