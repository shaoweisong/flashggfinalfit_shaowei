...
python /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Signal/scripts/calcPhotonSyst.py --cat cat12lowpurity --procs gghhwwgg --ext 2017_MX1000_MH125_2017_cat12lowpurity_wwgg --inputWSDir /eos/cms/store/group/phys_b2g/shsong/flashggws/cat12/2017/MX1000_MH125/ws_gghhwwgg_MX1000_MH125_2017_cat12lowpurity_wwgg --scales 'scale' --scalesCorr 'material,fnuf' --scalesGlobal '' --smears 'smear' 
