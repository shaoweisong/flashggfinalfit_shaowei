...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/eos/user/z/zhenxuan/hhwwgg_root/hhwwgg_root_ForSW_SL_resolved/ws_gghh_M900_2jets_SL_muon_passed100cut',
  'procs':'auto', # if auto: inferred automatically from filenames
  'cats':'auto', # if auto: inferred automatically from (0) workspace
  'ext':'dcb_%s_M900_2jets_SL_muon_passed100cut'%_year,
