...
if opt.cats in ['all','wall']:
  ...
  for cat in opt.cats.split(","):
    ...
    f = "%s/outdir_%s/CMS-HGG_sigfit_%s_%s_2016post.root"%(swd__,opt.ext,opt.ext,cat) #attention: only have 2017 year result with the name *_2017 so we add the _2017 in the str here
