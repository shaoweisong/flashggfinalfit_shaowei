...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/eos/cms/store/group/phys_b2g/shsong/flashggws/cat34/2018/MX500_MH125/ws_gghhwwgg_MX500_MH125_2018_cat34FHhighpurity',
  'procs':'auto', # if auto: inferred automatically from filenames
  'cats':'auto', # if auto: inferred automatically from (0) workspace
  'ext':'dcb_%s_MX500_MH125_2018_cat34FHhighpurity'%_year,
