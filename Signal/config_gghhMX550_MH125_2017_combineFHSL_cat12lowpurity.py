...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/eos/cms/store/group/phys_b2g/shsong/flashggws/cat12/2017/MX550_MH125/ws_gghh_MX550_MH125_2017_combineFHSL_cat12lowpurity',
  'procs':'auto', # if auto: inferred automatically from filenames
  'cats':'auto', # if auto: inferred automatically from (0) workspace
  'ext':'dcb_%s_MX550_MH125_2017_combineFHSL_cat12lowpurity'%_year,
