...
def run_makeDatacard(ws_sig_path,output_card_name,log_name,channel,process):
    ...
    if "wwgg" in process:
        ...
        command = "python makeDatacard_16resolved_bbgg.py --years 2016post --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
    elif "zzgg" in process:
        command = "python makeDatacard_16resolved_zzgg.py --years 2016post --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
    elif "ttgg" in process:
        command = "python makeDatacard_16resolved_ttgg.py --years 2016post --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
    else:
...
for mass in mass_list:
    for cat in cat_list:
        ...
        # ------------------------------------- background fit -------------------------------------
        input_path_name = "/eos/cms/store/group/phys_b2g/shsong/flashggws/cat34_graviton/2016post/" + mass + "/"
