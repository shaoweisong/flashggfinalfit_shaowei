...
rm *.log
combine -M AsymptoticLimits -m 125 -n Datacard_MX3000_MH125_2017_wwgg_cat12highpurity -d Datacard_MX3000_MH125_2017_wwgg_cat12highpurity.txt --run expected
text2workspace.py Datacard_MX3000_MH125_2017_wwgg_cat12highpurity.txt -m 125
rm higgsCombine*.AsymptoticLimits.mH125.root
rm BiasToys/*.root
python RunBiasStudy.py -d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Combine/Checks/Datacard_MX3000_MH125_2017_wwgg_cat12highpurity.root -t -n 1000 > Biastoy.log 2>&1
rm BiasFits/*.root
python RunBiasStudy.py -d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Combine/Checks/Datacard_MX3000_MH125_2017_wwgg_cat12highpurity.root  -n 1000 -f -c "--cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2 --freezeParameters MH,CMS_wwgg_br_HH_WWgg" > Fitlog.log 2>&1
rm  BiasPlots/*.p*
python RunBiasStudy.py -d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Combine/Checks/Datacard_MX3000_MH125_2017_wwgg_cat12highpurity.root -p --gaussianFit  > Pull.log 2>&1

rm *.log
combine -M AsymptoticLimits -m 125 -n Datacard_MX1750_MH125_2016post_wwgg_cat12highpurity -d Datacard_MX1750_MH125_2016post_wwgg_cat12highpurity.txt --run expected
text2workspace.py Datacard_MX1750_MH125_2016post_wwgg_cat12highpurity.txt -m 125
rm higgsCombine*.AsymptoticLimits.mH125.root
rm BiasToys/*.root
python RunBiasStudy.py -d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Combine/Checks/Datacard_MX1750_MH125_2016post_wwgg_cat12highpurity.root -t -n 1000 > Biastoy.log 2>&1
rm BiasFits/*.root
python RunBiasStudy.py -d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Combine/Checks/Datacard_MX1750_MH125_2016post_wwgg_cat12highpurity.root  -n 1000 -f -c "--cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2 --freezeParameters MH,CMS_wwgg_br_HH_WWgg" > Fitlog.log 2>&1
rm  BiasPlots/*.p*
python RunBiasStudy.py -d /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Combine/Checks/Datacard_MX1750_MH125_2016post_wwgg_cat12highpurity.root -p --gaussianFit  > Pull.log 2>&1
