...
# Open file with fits
f = ROOT.TFile("higgsCombine.bias_truth_exp_fit_poly.MultiDimFit.mH125.123456.root")
t = f.Get("limit")

hist_pull = ROOT.TH1F("pull_%s"%name, "Pull distribution: truth=%s, fit=%s"%(truth_function, fit_function), 80, -100, 100)
...
hist_pull.Fit("gaus")
plot_dir="/afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Combine/Checks/"
