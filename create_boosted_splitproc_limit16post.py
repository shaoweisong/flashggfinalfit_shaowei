...
def run_Tree2WS_sig(inputpath_name, inputfile_name, log_file_name, ws_path, output_sig_root_name, process):
    ...
    command = " python trees2ws.py --inputConfig config_sys16.py --inputTreeFile " + inputpath_name+inputfile_name + " --inputMass 125  --doSystematics --productionMode " + process_prefix + " --year 2016post  > " + log_file_name+ " 2>&1"
...
def run_ftest(ws_path, log_name, inputpath_name, process, isclean = False):
    ...
    if isclean:
        command = "rm -rf outdir_2016post_" + ws_path
...
def run_signalfit(ws_path, log_name, inputpath_name, process):
    ...
    command = "cp outdir_2016post_" + ws_path + "/signalFit/output/*.root" + " " + inputpath_name +  process + "_"+ws_path
    cp_p = subprocess.call(command, shell=True, stdout=subprocess.PIPE)
...
def run_yields(ws_sig_path,ws_bkg_path, inputpath_name,log_name, process):
    ...
    if "bbgg" in process:
        print("bbgg yields")
    # run Runyields
    # command = "python RunYields.py --inputWSDirMap 2016post=" +inputpath_name+ process + "_" + ws_sig_path+" --sigModelWSDir " + inputpath_name+ process + "_" + ws_sig_path+" --bkgModelWSDir " + inputpath_name+  ws_bkg_path + " --cats auto --doSystematics --procs auto --batch local --ext "+ ws_sig_path+ ">" + log_name+ " 2>&1"
        command = "python RunYields_16boosted_bbgg.py --inputWSDirMap 2016post=" +inputpath_name+ process + "_" + ws_sig_path+" --sigModelWSDir " + inputpath_name+ process + "_" + ws_sig_path+" --bkgModelWSDir " + inputpath_name+  ws_bkg_path + " --cats auto --doSystematics --procs "+process.split("ws_")[-1]+" --batch local --ext "+ ws_sig_path+ ">" + log_name+ " 2>&1"
    else:
        command = "python RunYields_16boosted.py --inputWSDirMap 2016post=" +inputpath_name+ process + "_" + ws_sig_path+" --sigModelWSDir " + inputpath_name+ process + "_" + ws_sig_path+" --bkgModelWSDir " + inputpath_name+  ws_bkg_path + " --cats auto --doSystematics --procs "+process.split("ws_")[-1]+" --batch local --ext "+ ws_sig_path+ ">" + log_name+ " 2>&1"
    print(command)
...
def run_makeDatacard(ws_sig_path,output_card_name,log_name,channel,process):
    ...
    os.chdir("/afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard")
    # run RunmakeDatacard
    if "combineFHSL" in output_card_name:
    # command = "python makeDatacard.py --years 2016post --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
        command = "python makeDatacard_16boosted.py --years 2016post --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
    elif "bbgg" in output_card_name:
        print("bbgg datacard")
        command = "python makeDatacard_16boosted_bbgg.py --years 2016post --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
    elif "zzgg" in output_card_name:
        command = "python makeDatacard_16boosted_zzgg.py --years 2016post --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
    elif "ttgg" in output_card_name:
        command = "python makeDatacard_16boosted_ttgg.py --years 2016post --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
    else:
        command = "python makeDatacard_16boosted.py --years 2016post --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
...
# mass_list=['MX550_MH125','MX500_MH125','MX600_MH125','MX650_MH125','MX700_MH125','MX750_MH125','MX800_MH125','MX900_MH125','MX1000_MH125', 'MX1100_MH125', 'MX1200_MH125', 'MX1300_MH125', 'MX1400_MH125', 'MX1500_MH125', 'MX1600_MH125', 'MX1700_MH125', 'MX1800_MH125','MX1900_MH125', 'MX2000_MH125', 'MX2200_MH125', 'MX2600_MH125', 'MX2800_MH125','MX2400_MH125','MX3000_MH125']
mass_list=['MX550_MH125','MX500_MH125','MX600_MH125','MX650_MH125','MX700_MH125','MX750_MH125','MX800_MH125','MX900_MH125','MX1000_MH125', 'MX1250_MH125', 'MX1500_MH125',  'MX1750_MH125', 'MX2000_MH125','MX2500_MH125','MX3000_MH125']
mass_list=['MX1000_MH125']


final_state = ""
cat_list = ['cat12highpurity','cat12lowpurity']
...
for mass in mass_list:
    for cat in cat_list:
        ...
        ext_name = "ws_2016post_" + cat + "_"+ mass
        ...
        for final_state in final_state_list:        
            # # # ------------------------------------- signal fit -------------------------------------
            input_file_name_signal = mass +"_2016post_"+final_state+"_"+cat+".root"
            log_file_name_signal = mass +"_hhwwgg_MC_2016post_"+cat+final_state+".log"
            ws_path_signal = mass +"_2016post_"+cat+"_"+final_state
            ...
            # run_makeDatacard(ws_sig_path=ws_path_signal, log_name = log_path + mass + cat + "_makeDatacard.log" , output_card_name = "Datacard_" + mass +"_2016post_" +final_state +"_"+ cat, channel=mass,process='gghh'+ final_state) 
