...
def run_yields(ws_sig_path,ws_bkg_path, inputpath_name,log_name, process):
    ...
    if "bbgg" in process:
        print("bbgg yields")
    # run Runyields
    # command = "python RunYields.py --inputWSDirMap 2018=" +inputpath_name+ process + "_" + ws_sig_path+" --sigModelWSDir " + inputpath_name+ process + "_" + ws_sig_path+" --bkgModelWSDir " + inputpath_name+  ws_bkg_path + " --cats auto --doSystematics --procs auto --batch local --ext "+ ws_sig_path+ ">" + log_name+ " 2>&1"
        command = "python RunYields_18boosted_combined.py --inputWSDirMap 2018=" +inputpath_name+ process + "_" + ws_sig_path+" --sigModelWSDir " + inputpath_name+ process + "_" + ws_sig_path+" --bkgModelWSDir " + inputpath_name+  ws_bkg_path + " --cats auto --doSystematics --procs "+process.split("ws_")[-1]+" --batch local --ext "+ ws_sig_path+ ">" + log_name+ " 2>&1"
    else:
        command = "python RunYields_18boosted.py --inputWSDirMap 2018=" +inputpath_name+ process + "_" + ws_sig_path+" --sigModelWSDir " + inputpath_name+ process + "_" + ws_sig_path+" --bkgModelWSDir " + inputpath_name+  ws_bkg_path + " --cats auto --doSystematics --procs "+process.split("ws_")[-1]+" --batch local --ext "+ ws_sig_path+ ">" + log_name+ " 2>&1"
    print(command)
...
def run_makeDatacard(ws_sig_path,output_card_name,log_name,channel,process):
    ...
    # command = "python makeDatacard.py --years 2018 --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
        command = "python makeDatacard_18boosted.py --years 2018 --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
    elif "bbgg" in output_card_name:
        print("bbgg datacard")
        command = "python makeDatacard_18boosted_combined.py --years 2018 --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
    elif "zzgg" in output_card_name:
        command = "python makeDatacard_18boosted_zzgg.py --years 2018 --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
    elif "ttgg" in output_card_name:
        command = "python makeDatacard_18boosted_ttgg.py --years 2018 --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
    else:
        command = "python makeDatacard_18boosted.py --years 2018 --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
...
for mass in mass_list:
    for cat in cat_list:
        ...
        # ------------------------------------- background fit -------------------------------------
        input_path_name = "/eos/cms/store/group/phys_b2g/shsong/flashggws/cat12_graviton/2018/" + mass + "/"
