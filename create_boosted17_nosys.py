...
#         print("bbgg yields")
#     # run Runyields
#         command = "python RunYields_17boosted_bbgg.py --inputWSDirMap 2017=" +inputpath_name+ process + "_" + ws_sig_path+" --sigModelWSDir " + inputpath_name+ process + "_" + ws_sig_path+" --bkgModelWSDir " + inputpath_name+  ws_bkg_path + " --cats auto --procs "+process.split("ws_")[-1]+" --batch local --ext "+ ws_sig_path+ ">" + log_name+ " 2>&1"
#     else:
#         command = "python RunYields_17boosted.py --inputWSDirMap 2017=" +inputpath_name+ process + "_" + ws_sig_path+" --sigModelWSDir " + inputpath_name+ process + "_" + ws_sig_path+" --bkgModelWSDir " + inputpath_name+  ws_bkg_path + " --cats auto --procs "+process.split("ws_")[-1]+" --batch local --ext "+ ws_sig_path+ ">" + log_name+ " 2>&1"
#     print(command)
...
#         command = "python makeDatacard_17boosted.py --years 2017 --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
#     elif "bbgg" in output_card_name:
#         print("bbgg datacard")
#         command = "python makeDatacard_17boosted_bbgg.py --years 2017 --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
#     elif "zzgg"  in output_card_name:
#         command = "python makeDatacard_17boosted_zzgg.py --years 2017 --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
#     elif "ttgg" in output_card_name:
#         command = "python makeDatacard_17boosted_ttgg.py --years 2017 --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
#     else:
#         command = "python makeDatacard_17boosted.py --years 2017 --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
...
# final_state_list = ["ttgg","wwgg","bbgg","zzgg","VBF","GGH","VH","TTH"]
# final_state_list = ["ttgg","wwgg","bbgg","zzgg"]
...
for mass in mass_list:
    for cat in cat_list:
        ...
        # ------------------------------------- background fit -------------------------------------
        input_path_name = "/eos/cms/store/group/phys_b2g/shsong/flashggws/cat12/2017_nosys/" + mass + "/"
