...
def run_makeDatacard(ws_sig_path,output_card_name,log_name,channel,process):
    ...
    command = "python makeDatacard_16resolved.py --years 2016 --doSystematics --prune --ext " + ws_sig_path + " --output "+ output_card_name+  ">" + log_name+ " 2>&1"
...
# mass_list=['MX270_MH125', 'MX1000_MH125']
final_state = ""
