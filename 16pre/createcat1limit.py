...
for mass in mass_list:
    for cat in cat_list:
        ...
        # ------------------------------------- background fit -------------------------------------
        input_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat1/2016pre/flashgginput/" + mass + "/"
        # exist_background_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat1/2016pre/flashgginput/M1000_SL/"
        exist_background_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat1/2016pre/flashgginput/M1000_SL/"
