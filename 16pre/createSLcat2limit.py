...
mass_list = ["M320_SL","M350_SL","M400_SL","M500_SL","M650_SL","M700_SL","M850_SL"]
...
for mass in mass_list:
    for cat in cat_list:
        ...
        # ------------------------------------- background fit -------------------------------------
        input_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat2/2016pre/flashgginput/" + mass + "/"
        # exist_background_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat2/2016pre/flashgginput/M1000_SL/"
