...
def run_Tree2WS_sig(inputpath_name, inputfile_name, log_file_name, ws_path, output_sig_root_name, process):
    ...
    command = " python trees2ws.py --inputConfig config_sys.py --inputTreeFile " + inputpath_name+inputfile_name + " --inputMass 125  --doSystematics --productionMode " + process_prefix + " --year 2016post  > " + log_file_name+ " 2>&1"
...
# mass_list=["M250_SL","M260_SL","M270_SL","M280_SL","M300_SL","M320_SL","M350_SL","M400_SL","M450_SL","M500_SL","M550_SL","M600_SL","M650_SL","M700_SL","M750_SL","M800_SL","M850_SL","M900_SL","M1000_SL","M1100_SL","M1200_SL","M1300_SL","M1400_SL","M1500_SL","M1600_SL","M1700_SL","M1800_SL","M1900_SL","M2000_SL","M2200_SL","M2400_SL","M2600_SL","M2800_SL","M3000_SL"]#
# mass_list=["M700_SL","M750_SL","M1200_SL"]#
mass_list=["M1000_SL","M1100_SL","M1200_SL","M1300_SL","M1400_SL","M1500_SL","M1600_SL","M1700_SL","M1800_SL","M1900_SL","M2000_SL","M2200_SL","M2400_SL","M2600_SL","M2800_SL","M3000_SL"]#
...
for mass in mass_list:
    for cat in cat_list:
        ...
        # ------------------------------------- background fit -------------------------------------
        input_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat5/2016post/flashgginput/" + mass + "/"
        # exist_background_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat5/2016post/flashgginput/M1000_SL/"
        exist_background_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat5/2016post/flashgginput/M1000_SL/"
        ...
        input_file_name_signal = "Signal_"+ mass +"_2016post_"+cat+".root"
        ...
        # run_combine(output_file_name=mass +"_2016post_" + cat, log_name = log_path + mass +"_2016post_" + cat +"_combine_limit.log" , output_card_name = "Datacard_" + mass +"_2016post_" + cat)
