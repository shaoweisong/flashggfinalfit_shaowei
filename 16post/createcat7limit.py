...
for mass in mass_list:
    for cat in cat_list:
        ...
        # ------------------------------------- background fit -------------------------------------
        input_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat7/2016post/flashgginput/" + mass + "/"
        # exist_background_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat7/2016post/flashgginput/M1000_FH/"
        exist_background_path_name = "/eos/user/s/shsong/HHWWgg_limit/optimise/cat7/2016post/flashgginput/M1000_FH/"
